...
const HomeCard = () => {
  return (
    <div>
      <div className="w-full mb-6 lg:mb-0  mx-auto   relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[140px] md:mt-[220px] lg:mt-0 ">
        <img
          src={img}
          ...
          <div className="p-7 rounded-2xl mt-7  bg-[#F3F6F6] dark:bg-[#1D1D1D]">
            ...
            <div className="flex  border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
              ...
              <div className="text-left ml-2.5">
                ...
                <p className="dark:text-white break-all">
                  ...
                  <a
                    className="hover:text-[#FA5252] duration-300 transition"
                    href="sahanahemraj01@email.com"
                  >
                    
                      sahanahemraj01@email.com
                  </a>
                </p>
              </div>
            </div>
            ...
            <div className="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
              ...
              <div className="text-left ml-2.5">
                ...
                <p className="dark:text-white break-all">Chicago IL, USA</p>
              </div>
            </div>
            ...
            <div className="flex  py-2.5">
              ...
              <div className="text-left ml-2.5">
                ...
                <p className="dark:text-white break-all">Oct 02, 2001</p>
              </div>
            </div>
          </div>

          <a
            href={"https://sahanaresume11.tiiny.site/"}
            download
